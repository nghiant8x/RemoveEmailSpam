...
@interface TableViewManager : NSObject <MVSelectionOwner, MailTableViewDelegate, NSTableViewDataSource>
{
    ...
    BOOL _isShowingSearchResults;	// 109 = 0x6d
    BOOL _awaitingInitialScrollPosition;	// 110 = 0x6e
    BOOL _scrollFoundSelectionIntoView;	// 111 = 0x6f
    BOOL _awaitingInitialSelection;	// 112 = 0x70
    BOOL _clearSelectionOnUpdate;	// 113 = 0x71
    BOOL _threadOpeningIsInProgress;	// 114 = 0x72
    BOOL _threadClosingIsInProgress;	// 115 = 0x73
    BOOL _doubleClickThreadOpeningIsInProgress;	// 116 = 0x74
    BOOL _animatingThreadOpening;	// 117 = 0x75
    BOOL _animatingThreadClosing;	// 118 = 0x76
    BOOL _dontUpdateTrackingRects;	// 119 = 0x77
    BOOL _useBoldFontForUnreadMessages;	// 120 = 0x78
    BOOL _clearingSearch;	// 121 = 0x79
    BOOL _selectionShouldNotChange;	// 122 = 0x7a
    BOOL _selectingMessagesForTransfer;	// 123 = 0x7b
    BOOL _needsColumnSetup;	// 124 = 0x7c
    BOOL _keepSelectionWhenTogglingThread;	// 125 = 0x7d
    unsigned char _suspendChangesToScrollingAndSelection;	// 126 = 0x7e
    BOOL _isRichMessageList;	// 127 = 0x7f
    BOOL _didAwake;	// 128 = 0x80
    BOOL _isShowingToCc;	// 129 = 0x81
    int _nextMessageDirection;	// 132 = 0x84
    int _searchTarget;	// 136 = 0x88
    MailTableView *_tableView;	// 144 = 0x90
    MessageViewer *_delegate;	// 152 = 0x98
    MessageListContainerView *_messageListContainerView;	// 160 = 0xa0
    NSArray *_tableColumns;	// 168 = 0xa8
    NSMapTable *_storeStateTable;	// 176 = 0xb0
    NSDictionary *_messageIDsToSelectWhenOpened;	// 184 = 0xb8
    NSArray *_threadIDsToOpenWhenOpened;	// 192 = 0xc0
    long long _sortColumnOrder;	// 200 = 0xc8
    long long _mailboxSortColumnOrder;	// 208 = 0xd0
    long long _initialScrollType;	// 216 = 0xd8
    TableViewScrollState *_savedScrollState;	// 224 = 0xe0
    NSDictionary *_initialMailboxViewingState;	// 232 = 0xe8
    long long _windowWidthBeforeSearch;	// 240 = 0xf0
    NSFont *_boldFont;	// 248 = 0xf8
    NSArray *_draggedMessages;	// 256 = 0x100
    NSArray *_filteredMessagesFromMouseDown;	// 264 = 0x108
    NSString *_messageIDToReveal;	// 272 = 0x110
    NSCache *_snippetsForMessage;	// 280 = 0x118
    ConversationPrefetcher *_conversationPrefetcher;	// 288 = 0x120
    NSArray *_expandedSelection;	// 296 = 0x128
    NSArray *_expandedSelectionForTransfer;	// 304 = 0x130
    long long _leftmostTextColumn;	// 312 = 0x138
    long long _colorHighlightLeftEdge;	// 320 = 0x140
    long long _colorHighlightWidth;	// 328 = 0x148
    MFMessageThread *_threadBeingClosed;	// 336 = 0x150
    MFMessageThread *_threadBeingOpened;	// 344 = 0x158
    long long _lastMouseDownInUnreadColumnEventNumber;	// 352 = 0x160
    long long _numberOfSelectedRowsBeforeTogglingThread;	// 360 = 0x168
    unsigned long long _numberOfSnippetLines;	// 368 = 0x170
    NSTableColumn *_richTableColumn;	// 376 = 0x178
    NSTableHeaderView *_tableHeaderView;	// 384 = 0x180
    long long _previouslyViewedMessageRow;	// 392 = 0x188
    long long _currentViewedMessageRow;	// 400 = 0x190
    long long _searchField;	// 408 = 0x198
    struct _NSRange _filteredMessagesRange;	// 416 = 0x1a0
    struct CGPoint _lastMouseDownInUnreadColumnPoint;	// 432 = 0x1b0
    struct CGPoint _currentMouseLocationInWindow;	// 448 = 0x1c0
}
