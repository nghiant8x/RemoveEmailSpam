...
@interface MessageViewer : NSResponder <FlaggedStatusToolbarItemDelegate, MessageViewerSearchFieldFocusDelegate, NSToolbarDelegate, MailboxesOutlineViewControllerDelegate, MailTableViewDelegateDelegate, MCActivityTarget, MessageTransferDelegate, MVMailboxSelectionOwner, MVTerminationHandler, NSAnimationDelegate, NSSpeechSynthesizerDelegate, NSUserInterfaceValidations, NSWindowDelegate, SGTSearchFieldQueryScopeDelegate>
{
    ...
    NSSet *_initiallySelectedMessages;	// 32 = 0x20
    NSMutableArray *_transferOperations;	// 40 = 0x28
    FullScreenWindowController *_fullScreenWindowController;	// 48 = 0x30
    MailboxesSplitViewController *_mailboxesSplitViewController;	// 56 = 0x38
    struct __MDQuery *_lowPriorityQuery;	// 64 = 0x40
    struct __MDQuery *_highPriorityQuery;	// 72 = 0x48
    BOOL _ignoreSearchBarUpdates;	// 80 = 0x50
    BOOL _previouslyHadSentScope;	// 81 = 0x51
    BOOL _allowShowingDeletedMessages;	// 82 = 0x52
    BOOL _suppressWindowTitleUpdates;	// 83 = 0x53
    BOOL _didSetupUI;	// 84 = 0x54
    BOOL _shouldCascadeWhenShowing;	// 85 = 0x55
    BOOL _atLeastOneSelectedMessageIsInOutbox;	// 86 = 0x56
    BOOL _atLeastOneSelectedMessageIsInOutboxIsValid;	// 87 = 0x57
    BOOL _atLeastOneSelectedMessageIsInDrafts;	// 88 = 0x58
    BOOL _atLeastOneSelectedMessageIsInDraftsIsValid;	// 89 = 0x59
    BOOL _changingSplitViewOrientation;	// 90 = 0x5a
    BOOL _timeMachineRestoreIsInProgress;	// 91 = 0x5b
    BOOL _performedEarlyDealloc;	// 92 = 0x5c
    int _searchTarget;	// 96 = 0x60
    TableViewManager *_tableManager;	// 104 = 0x68
    NSView *_viewingPaneContainerView;	// 112 = 0x70
    ViewingPaneViewController *_viewingPaneViewController;	// 120 = 0x78
    MailboxesOutlineViewController *_outlineViewController;	// 128 = 0x80
    FullScreenModalCapableWindow *_window;	// 136 = 0x88
    MailSplitView *_contentSplitView;	// 144 = 0x90
    MessageListContainerView *_messageListContainerView;	// 152 = 0x98
    MailSplitView *_mailboxesSplitView;	// 160 = 0xa0
    NSView *_viewerContainer;	// 168 = 0xa8
    NSView *_mailboxesView;	// 176 = 0xb0
    NSView *_mailboxesContainer;	// 184 = 0xb8
    NSLayoutConstraint *_mailboxesWidthConstraint;	// 192 = 0xc0
    ActivityViewController *_activityViewController;	// 200 = 0xc8
    MessageViewerSearchField *_searchField;	// 208 = 0xd0
    NSToolbarItem *_searchViewItem;	// 216 = 0xd8
    FlaggedStatusToolbarItem *_flaggedStatusToolbarItem;	// 224 = 0xe0
    NSToolbarItem *_fullScreenFlagMenuToolbarItem;	// 232 = 0xe8
    MailToolbar *_toolbar;	// 240 = 0xf0
    NSDictionary *_toolbarItems;	// 248 = 0xf8
    NSMenu *_tableHeaderMenu;	// 256 = 0x100
    NSMenu *_sortByTableHeaderMenu;	// 264 = 0x108
    MessageViewerLazyPopUpButton *_makeNewMailboxButton;	// 272 = 0x110
    MessageViewerLazyPopUpButton *_actionButton;	// 280 = 0x118
    NSDictionary *_savedAttributes;	// 288 = 0x120
    NSWindow *_timeMachineRestoreMessagesWindow;	// 296 = 0x128
    NSTextField *_timeMachineRestoreMessagesField;	// 304 = 0x130
    NSWindow *_timeMachineRestoreMailboxWindow;	// 312 = 0x138
    NSTextField *_timeMachineRestoreMailboxField;	// 320 = 0x140
    FavoritesBarViewController *_favoritesBarViewController;	// 328 = 0x148
    NSString *_searchQuery;	// 336 = 0x150
    long long _currentSearchField;	// 344 = 0x158
    long long _selectedTag;	// 352 = 0x160
    NSMenu *_messageColumnsMenu;	// 360 = 0x168
    NSMenu *_messageSortByMenu;	// 368 = 0x170
    NSMenuItem *_columnsMenuItem;	// 376 = 0x178
    NSMenuItem *_sortByMenuItem;	// 384 = 0x180
    NSMenuItem *_dateReceivedMenuItem;	// 392 = 0x188
    NSMenuItem *_dateSentMenuItem;	// 400 = 0x190
    NSMenuItem *_dateReceivedTableHeaderMenuItem;	// 408 = 0x198
    NSMenuItem *_dateSentTableHeaderMenuItem;	// 416 = 0x1a0
    double _restoreMailboxPaneToWidthAfterDragOperation;	// 424 = 0x1a8
    NSArray *_mailboxesToDisplayWhenVisible;	// 432 = 0x1b0
    NSDictionary *_initialWindowState;	// 440 = 0x1b8
    NSNumber *_uniqueID;	// 448 = 0x1c0
    NSTimer *_timeMachineRestoreSheetTimer;	// 456 = 0x1c8
    ContentSplitViewController *_contentSplitViewController;	// 464 = 0x1d0
    MFBehaviorTracker *_behaviorTracker;	// 472 = 0x1d8
}
